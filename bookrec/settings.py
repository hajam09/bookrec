"""
Django settings for bookrec project.
...
SECRET_KEY = 'django-insecure-b^zo2zfg4f2@_35%$ien5-tu2ufrlsm1ok=hrwdja4gsb#@k_$'
...
WSGI_APPLICATION = 'bookrec.wsgi.application'
