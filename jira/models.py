...
class Ticket(models.Model):
    url = models.CharField(max_length=1024)
    project = models.CharField(max_length=1024, choices=PROJECT_CHOICES, default='Bookrec')
    issue_type = models.CharField(max_length=1024, choices=ISSUE_TYPE_CHOICES, default='Bug')
    reporter = models.ForeignKey(User, models.SET_NULL, blank=True, null=True, related_name="reporter")
    assignee = models.ForeignKey(User, models.SET_NULL, blank=True, null=True, related_name="assignee")
